...
class _AppApi implements AppApi {
  ...
  @override
  Future<dynamic> insertProduct(ProductRequest? request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
  ...
  Future<dynamic> deleteProduct(
    ...
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          'category/${categoryId}/product/${id}',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  @override
  Future<CategoryResponse> category(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> insertCategory(CategoryRequest? request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _headers = <String, dynamic>{};
